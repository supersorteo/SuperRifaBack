...
public class CloudinaryService {
    ...
    private static final int  MAX_IMAGES_PER_RAFFLE = 5;

    @SuppressWarnings("unchecked")
    public UploadResult uploadRaffleImage(MultipartFile file, UUID raffleId) throws IOException {
    ...
    public int getMaxImagesPerRaffle() {
        return MAX_IMAGES_PER_RAFFLE;
    }
